...
export class BlogHeader extends React.Component{
    ...
    return(
        <div className="BlogHeader">
            ...
            <div id="bh_id_nav">
                <a id="bh_id_nav_link1" href="/products">Products</a>
                <a id="bh_id_nav_link2" href="/forum">Forum</a>
                <a id="bh_id_nav_link3" href="/research">Research</a>
                <a id="bh_id_nav_link4" href="/news">News</a>
                <a id="bh_id_nav_link5" href="/contact">Contact</a>
            </div>
            <div id="bh_id_shop">
                <a id="bh_id_shop_link1" href="/login">
                <div id="bh_id_shop_box">
                  Login
                </div>
                </a>
            </div>
